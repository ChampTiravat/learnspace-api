 ...
 * @param { candidateIdent } [GRAPHQL_ARGS] : Identification(Email or Username) of the candidate(target user who recieve an invitation)
...
export default async (_, { candidateIdent, classroomID }, { models, user }) => {
  try {
    ...
    // ---------------------------------------------------------------------
    // Find the user candidate using his/her email or username, depending on what's being given
